...
// in simulator we redefine to format for wego Developer console
...
{\
	NSString * exceptionName = [@"org.wego." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wego";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIwegoNativeItemNone = -1, 
	UIwegoNativeItemSpinner = -2,
	UIwegoNativeItemProgressBar = -3,
	
	UIwegoNativeItemSlider = -4,
	UIwegoNativeItemSwitch = -5,
	UIwegoNativeItemMultiButton = -6,
	UIwegoNativeItemSegmented = -7,
	
	UIwegoNativeItemTextView = -8,
	UIwegoNativeItemTextField = -9,
	UIwegoNativeItemSearchBar = -10,
	
	UIwegoNativeItemPicker = -11,
	UIwegoNativeItemDatePicker = -12,
	
	UIwegoNativeItemInfoLight = -13,
	UIwegoNativeItemInfoDark = -14,
	
	UIwegoNativeItemDisclosure = -15,
	
	UIwegoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all wego instances of
