...
/**
 The base class for all wego modules
 */
...
/**
 wego Platform calls this method on startup.
 */
-(void)startup;

/**
 wego Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 wego Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 wego Platform calls this method on resume.
 @param sender The sender of the event.
 */
