 ...
 * Copyright (c) 2009-2011 by wego, Inc. All Rights Reserved.
...
//@interface wegoObject : NSObject
//@end

@interface wegoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[wegoObject class]])
		{
			for (NSString *key in [[(wegoObject*)o modules] allKeys])
			{
